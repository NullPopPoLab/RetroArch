...
static const struct retro_keybind retro_keybinds_1[] = {
   ...
   },
   {
      NULL, NULL,
      AXIS_NONE, AXIS_NONE, AXIS_NONE,
      MENU_ENUM_LABEL_VALUE_INPUT_JOYPAD_OPT1, RETROK_UNKNOWN,
      RETRO_DEVICE_ID_JOYPAD_OPT1, NO_BTN, NO_BTN, 0,
      true
   },
   {
      NULL, NULL,
      AXIS_NONE, AXIS_NONE, AXIS_NONE,
      MENU_ENUM_LABEL_VALUE_INPUT_JOYPAD_OPT2, RETROK_UNKNOWN,
      RETRO_DEVICE_ID_JOYPAD_OPT2, NO_BTN, NO_BTN, 0,
      true
   },
   {
      NULL, NULL,
