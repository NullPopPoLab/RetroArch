...
#define RARCH_MAX_KEYS 199

#define RARCH_DIGITAL_BIND_LIST_END    32
#define RARCH_FIRST_CUSTOM_BIND        RARCH_DIGITAL_BIND_LIST_END
...
enum input_turbo_default_button
{
   ...
   INPUT_TURBO_DEFAULT_BUTTON_C,
   INPUT_TURBO_DEFAULT_BUTTON_Z,
   INPUT_TURBO_DEFAULT_BUTTON_L4,
   INPUT_TURBO_DEFAULT_BUTTON_R4,
   INPUT_TURBO_DEFAULT_BUTTON_L5,
   INPUT_TURBO_DEFAULT_BUTTON_R5,
   INPUT_TURBO_DEFAULT_BUTTON_L0,
   INPUT_TURBO_DEFAULT_BUTTON_R0,
   INPUT_TURBO_DEFAULT_BUTTON_G1,
   INPUT_TURBO_DEFAULT_BUTTON_G2,
   INPUT_TURBO_DEFAULT_BUTTON_G3,
   INPUT_TURBO_DEFAULT_BUTTON_G4,
   INPUT_TURBO_DEFAULT_BUTTON_G5,
   INPUT_TURBO_DEFAULT_BUTTON_G6,
