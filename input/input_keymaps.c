...
const struct rarch_key_map rarch_key_map_linux[] = {
   ...
   { KEY_RO, RETROK_ROMAN },
   { KEY_KATAKANA, RETROK_KATAKANA },
   { KEY_HIRAGANA, RETROK_HIRAGANA },
   { KEY_KATAKANAHIRAGANA, RETROK_KATAHIRA },
   { KEY_ZENKAKUHANKAKU, RETROK_ZENHAN },
   { KEY_HENKAN, RETROK_CONVERT },
   { KEY_MUHENKAN, RETROK_DONTCONV },
   { KEY_YEN, RETROK_YEN },
   { KEY_CALC, RETROK_CALC },
   { KEY_SLEEP, RETROK_SLEEP },
