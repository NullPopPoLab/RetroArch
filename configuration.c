...
const struct input_bind_map input_config_bind_map[RARCH_BIND_LIST_END_NULL] = {
   ...
   DECLARE_BIND(opt1,                          RETRO_DEVICE_ID_JOYPAD_OPT1,  MENU_ENUM_LABEL_VALUE_INPUT_JOYPAD_OPT1),
   DECLARE_BIND(opt2,                          RETRO_DEVICE_ID_JOYPAD_OPT2,  MENU_ENUM_LABEL_VALUE_INPUT_JOYPAD_OPT2),
