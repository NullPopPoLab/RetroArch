...
struct key_desc key_descriptors[RARCH_MAX_KEYS] =
{
   ...
   {RETROK_KATAHIRA    ,  "Katakana/Hiragana"},
   {RETROK_ZENHAN      ,  "Zenkaku/Hankaku"},
   ...
   {RETROK_KP147       ,  "Numpad 1,4,7 (Leftside)"},
   {RETROK_KP369       ,  "Numpad 3,6,9 (Rightside)"},
   ...
   {RETROK_JOYPAD_9    ,  "Joypad Button 9"},
   {RETROK_JOYPAD_10   ,  "Joypad Button 10"},
   {RETROK_JOYPAD_11   ,  "Joypad Button 11"},
   {RETROK_JOYPAD_12   ,  "Joypad Button 12"},
   {RETROK_JOYPAD_13   ,  "Joypad Button 13"},
   {RETROK_JOYPAD_14   ,  "Joypad Button 14"},
   {RETROK_JOYPAD_15   ,  "Joypad Button 15"},
   {RETROK_JOYPAD_16   ,  "Joypad Button 16"},
   ...
   {RETROK_MOUSE_6     ,  "Mouse Button 6"},
   {RETROK_MOUSE_7     ,  "Mouse Button 7"},
   {RETROK_MOUSE_8     ,  "Mouse Button 8"},
   {RETROK_MOUSE_9     ,  "Mouse Button 9"},
};
